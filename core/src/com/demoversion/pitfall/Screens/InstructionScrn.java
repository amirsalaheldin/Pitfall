...
import com.demoversion.pitfall.MainMenu.InstructionButtons;


public class  InstructionScrn implements Screen{
    ...
    private InstructionButtons button;


    public InstructionScrn(MainGame game){
        this.game=game;
        ...
        background = new Texture("Main Menu Backgrounds/Instructions.png");

        button = new InstructionButtons(game);
