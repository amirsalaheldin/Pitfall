...
import com.demoversion.pitfall.MainMenu.GameOverButtons;
...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(MainGame game){
        ...
        background = new Texture("Main Menu Backgrounds/gameover.png");
        buttons = new GameOverButtons(game);

        GameManager.getInstance().playGameOverMusic();
